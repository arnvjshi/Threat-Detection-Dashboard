  ...
  const developers = [
    {
      name: "Arnav Joshi",
      role: "Lead Developer",
      github: "https://github.com/arnavjoshi",
      email: "arnavjoshi@example.com",
      website: "https://github.com/arnavjoshi",
      description: "Lead developer responsible for the architecture and implementation of the threat detection system.",
    },
    {
      ...
      description: "Specialized in AI model integration and optimization for threat detection algorithms.",
    },
    {
      name: "Paras Badwaik",
      ...
      description: "Responsible for creating the responsive and interactive user interface of the application.",
    },
    {
      name: "Ayush Dhamecha",
      ...
      description: "Developed the backend infrastructure and API integrations for the threat detection platform.",
    },
  ]
